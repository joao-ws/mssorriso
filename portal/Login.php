...
if (isset($_SESSION['dados_removidos']) && $_SESSION['dados_removidos'] === true) {
    // Mensagem informando que os dados foram removidos
    echo '<script>alert("Seus dados foram removidos do sistema.");</script>';
    unset($_SESSION['dados_removidos']); // Limpa a variável de sessão
}
include('conexao.php');
