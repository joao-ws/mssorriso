...
if(!empty($_GET['search'])) {
	...
	WHERE id_agendamento LIKE '%$data%' or nome_paciente LIKE '%$data%' or data LIKE '%$data%' or hora LIKE '%$data%' or procedimento LIKE '%$data%' ORDER BY id_agendamento DESC";
	...
	<script>
		function confirmDeleteAgenda(id) {
    		if (confirm("Tem certeza de que deseja excluir este agendamento?")) {
        		window.location.href = 'deleteag.php?id=' + id;
    }
}
</script>
</head>
