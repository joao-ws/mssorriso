...
<head>
    ...
    <script>
        function confirmUpdate() {
            if (confirm("Tem certeza de que deseja atualizar este agendamento?")) {
            return true;
        // Usuário confirmou, então direcione para saveeditag.php
                window.location.href = "saveeditag.php?id=<?php echo $id; ?>";
    } else {
        return false;
...
<header>
    ...
    <div id="conteudo-principal">
        ...
        <form class="formulario" method="post" action="saveeditag.php">
        ...
        <div class="text-area-buttons">
            ...
            <div class="botão">
                ...
                <input type="submit" name="updateagenda" id="updateagenda" onclick="return confirmUpdate();">
            </div>
        </form>
    </div>
</body>