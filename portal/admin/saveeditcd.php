<?php
    ...
    if (isset($_POST['updatecadastro'])) {
        ...
        $email = $_POST['email'];
            ...
            $sqlUpdatePaciente = "UPDATE paciente 
            SET nome_paciente='$nome_paciente', cpf='$cpf', telefone='$telefone' WHERE id_paciente=$id";

            $sqlUpdateLogin = "UPDATE login 
            SET email='$email' WHERE codigo_login=$id";
