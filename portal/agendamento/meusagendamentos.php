...
FROM agendamento JOIN paciente ON agendamento.id_paciente = paciente.id_paciente WHERE agendamento.id_paciente = '$codigo_login' ORDER BY agendamento.id_agendamento DESC";
			...
			<?php
				while($user_data = mysqli_fetch_assoc($result))
				{
					...
					echo "<td>
						...
						<a class='btn btn-sm btn-danger' href='delete.php?id=$user_data[id_agendamento]'>
